        ...
        async function loadArenas() {
            if (dbUser) {
                try {
                    ...
                    if (data.length === 1) {
                        router.replace(`/dashboard/loyalty/${data[0].id}`);
                    }
                } catch (error) {
        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">
                    Selecione uma arena para gerenciar sua moeda de fidelidade.
                </p>
            </div>
                ...
                <Card className="col-span-full py-12">
                    <CardContent className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-muted-foreground max-w-sm mb-6">
                            Para gerenciar seu programa de fidelidade, você precisa de uma arena ativa.
                        </p>
                        ...
                        <Card key={arena.id} className="hover:shadow-md transition-shadow">
                            ...
                            <CardContent>
                                ...
                                <div className="flex gap-2">
                                    <Link href={`/dashboard/loyalty/${arena.id}`} className="w-full">
