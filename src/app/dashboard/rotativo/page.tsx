...
export default function RotativoIndexPage() {
        ...
        async function loadArenas() {
            if (dbUser) {
                try {
                    ...
                    if (data.length === 1) {
                        router.replace(`/dashboard/rotativo/${data[0].id}`);
                    }
                } catch (error) {
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-3xl font-bold tracking-tight">Rotativo</h2>
                <p className="text-muted-foreground">
                    Selecione uma arena para gerenciar acessos rotativos.
                </p>
            </div>
                ...
                <Card className="col-span-full py-12">
                    <CardContent className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-muted-foreground max-w-sm mb-6">
                            Para gerenciar sessões rotativas, é necessário ter uma arena ativa.
                        </p>
                        ...
                        <Card key={arena.id} className="hover:shadow-md transition-shadow">
                            ...
                            <CardContent>
                                ...
                                <div className="flex gap-2">
                                    <Link href={`/dashboard/rotativo/${arena.id}`} className="w-full">
